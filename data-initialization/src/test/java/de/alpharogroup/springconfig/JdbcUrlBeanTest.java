...
public class JdbcUrlBeanTest {
	...
	public void testNewH2JdbcUrl() {
		...
		final JdbcUrlBean bean = JdbcUrlBean.builder().protocol("jdbc:h2:").database("file:~/bundlemanagement")
				.parameter("MODE=PostgreSQL").parameter("DB_CLOSE_ON_EXIT=FALSE").parameter("DB_CLOSE_DELAY=-1")
				.build();
	...
	public void testNewMysqlJdbcUrl() {
		...
		final JdbcUrlBean bean = JdbcUrlBean.builder().protocol("jdbc:mysql://").host("10.0.101.23").port(5555)
				.database("foo").build();
	...
	public void testNewPostgresJdbcUrl() {
		...
		final JdbcUrlBean bean = JdbcUrlBean.builder().protocol("jdbc:postgresql://").host("10.0.101.23").port(5555)
				.database("foo").build();
