...
public class WebClientExtensions {
	...
	/**
	 * Factory method for create a new {@link ClientAuthentication} from the given
	 * parameters.
	 *
	 * @param want     the want
	...
	/**
	 * Factory method for create a new {@link JAXRSServerFactoryBean} from the given
	 * parameters. Service and resource classes have to be added.
	 *
	...
	/**
	 * Factory method for create a new {@link TLSServerParameters} from the given
	 * parameters.
	 *
	...
	public static TLSClientParameters newTLSClientParameters(File keystoreDir, String keystoreFilename,
		...
		final TLSClientParameters tlsClientParameters = WebClientExtensions.newTLSClientParameters(
				...
				trustManagersKeystorePassword, keyManagersKeystoreFile, keyManagerAlgorithm, keyManagersKeystoreType,
				keyManagersKeystorePassword, cipherSuitesFilter, disableCNCheck);
		return tlsClientParameters;
	}

	/**
	 * Factory method for create a new {@link TLSClientParameters} from the given
	 * parameters.
	 *
	...
	public static void setClientConfiguration(Object client, File trustManagersKeystoreFile,
		...
		final TLSClientParameters tlsParams = newTLSClientParameters(trustManagersKeystoreFile, trustManagerAlgorithm,
