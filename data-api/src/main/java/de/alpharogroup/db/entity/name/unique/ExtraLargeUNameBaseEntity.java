 ...
 * @deprecated use instead {@link VersionableExtraLargeUniqueNameEntity}. will be deleted on next minor
 *             release.
 */
@Deprecated
@MappedSuperclass
...
@NoArgsConstructor
@AllArgsConstructor
public abstract class ExtraLargeUNameBaseEntity<T extends Serializable>
	extends
