...
/**
 * The class {@link VersionableExtraLargeNameEntity} is a base entity for a table with a single value.
 *
 * @param <T>
...
@NoArgsConstructor
@AllArgsConstructor
public abstract class VersionableExtraLargeNameEntity<T extends Serializable>
	extends
