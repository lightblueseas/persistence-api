...
public class CustomTypeModulesRegistrationProvider extends JacksonJsonProvider {
	...
	/**
	 * Instantiates a new new {@link CustomTypeModulesRegistrationProvider} object
	...
	/**
	 * Instantiates a new {@link CustomTypeModulesRegistrationProvider} object with
	 ...
	 *
	 * @param mapper           the object mapper
	 * @param annotationsToUse Sets of annotations (Jackson, JAXB) that provider
	 *                         should support
	 */
	 ...
	 * invoked in the constructor and can be overridden so users can add specific
	 * type modules for the specific provider.
	 *
