...
/**
 * The abstract class {@link AbstractEntityBOMapper} provides an base implementation for mapping entities to business objects and back.
 *
 * @param <E> the element type
 * @param <BO> the generic type
 */
		...
		EntityBOMapper<E, BO>
{
	...
	/**
	 * Factory method for creating the new {@link Mapper} for the mapping process with the given mapping files list. This method is invoked
	 * in the constructor and can be overridden so users can provide their
	 * own mapping process. 
	 * 
	 * @param mappingFiles the mapping files
	 *
