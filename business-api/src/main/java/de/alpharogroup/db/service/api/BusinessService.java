...
public interface BusinessService<T extends BaseEntity<PK>, PK extends Serializable> extends Serializable {
	 ...
	 * 
	 * @param objects the list with the persistent objects to delete
	 */
	 ...
	 *
	 * @param jpqlString the jpql query as string
	 * @return the query
	 */
	 ...
	 * 
	 * @param objects the list to save
	 ...
	 * 
	 * @param object the new instance to save.
